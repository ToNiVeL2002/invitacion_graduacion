...
export default function CarlaFooter() {
  const { closingLine1, closingLine2 } = carlaEventData

  return (
    <footer
      id="footer"
      className="w-full relative pt-16 pb-28 sm:pt-24 sm:pb-36 px-4 sm:px-8 flex flex-col items-center justify-center text-center overflow-hidden"
    ...
    >
      ...
      <div className="flex flex-col items-center justify-center mt-8">
        <p className="font-montserrat text-xs sm:text-sm tracking-widest text-[#F8F4EC]/70 uppercase font-medium text-center">
          Desarrollado por: <span className="text-[#D8B86A] font-semibold">mi</span>
        </p>
      </div>
    </footer>
  )
