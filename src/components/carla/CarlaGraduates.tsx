...
export default function CarlaGraduates() {
  const { graduate } = carlaEventData

  return (
    <section
      id="graduado"
      className="w-full pt-32 pb-28 sm:pt-40 sm:pb-36 md:pt-48 md:pb-44 px-4 sm:px-8 md:px-12 flex flex-col items-center justify-center relative overflow-hidden"
