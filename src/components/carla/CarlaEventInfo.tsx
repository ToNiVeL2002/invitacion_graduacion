...
export default function CarlaEventInfo() {
  return (
    <section
      id="evento"
      className="w-full py-24 sm:py-32 md:py-40 px-6 sm:px-10 md:px-16 flex flex-col items-center justify-center relative"
    ...
    >
      ...
      <div className="w-full max-w-6xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 justify-items-center">
        ...
        <InfoCard
          icon={<Clock size={24} />}
          title="Hora"
          value={carlaEventData.eventTime}
          sub={carlaEventData.eventType}
          delay={0.1}
        />
        <InfoCard
          icon={<MapPin size={24} />}
          title="Lugar"
          value={carlaEventData.venue}
          sub={carlaEventData.address}
          delay={0.2}
        />
        <InfoCard
          icon={<Sparkles size={24} />}
          title="Recepción"
          value="Brindis de Honor"
          sub="y Celebración"
          delay={0.3}
        />
      </div>
