        ...
        <ScrollReveal variant="fadeUp" className="flex flex-col items-center justify-center w-full">
          ...
          <div
            ...
            style={{
              ...
              boxShadow:
                '0 20px 60px rgba(11, 35, 65, 0.08), inset 0 0 0 1px rgba(200, 162, 74, 0.2)',
            }}
          >
            ...
            <p className="font-cinzel tracking-[0.35em] text-xs sm:text-sm uppercase mb-3 font-semibold text-[#143A63] text-center w-full">
              INVITACIÓN DE HONOR
            </p>

            {/* Nombre de los Anfitriones */}
            <h2 className="font-cinzel text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold mb-6 tracking-wide text-[#0B2341] uppercase leading-snug sm:leading-relaxed text-center w-full px-2 sm:px-6">
              {eventData.host}
            </h2>
